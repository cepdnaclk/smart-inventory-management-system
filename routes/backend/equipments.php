...
// Store
Route::post('equipments/types/{equipmentTypes}', [EquipmentTypesController::class, 'store']);
...
// Update
Route::put('equipments/types/{equipmentItem}', [EquipmentTypesController::class, 'update']);
