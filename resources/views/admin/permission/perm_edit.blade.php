...
@section('content')
    <div class="container" style="">
        ...
        <div class="row">
            <div class="container">
                <div class="p-2"><h3>Edit Permission</h3></div>
            </div>
        </div>

        <div class="row">
            <div class="container pl-4">
                <form method="post" action="{{ route('permission.update', $permission->id) }}" data-parsley-validate
                      class="form-horizontal form-label-left">

                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} row">
                        <label for="name" class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                            <input type="text" value="{{$permission->name}}" id="name" name="name"
                    ...
                    <div class="form-group{{ $errors->has('display_name') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{$permission->display_name}}" id="display_name"
                                   name="display_name"
                    ...
                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{$permission->description}}" id="description" name="description"
