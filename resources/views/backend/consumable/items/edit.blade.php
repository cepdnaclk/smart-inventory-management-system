...
@section('content')
    <div>
        {!! Form::open(['url' => route('admin.consumable.items.update',
                  compact('consumableItem')),
                  'method' => 'put',
                  'class' => 'container',
                  'files'=>true,
        ...
        <x-backend.card>
            ...
            <x-slot name="body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        {!! Form::select('consumable_type_id', $types, $consumableItem->consumable_type_id, ['class'=>'form-control', 'required'=>true, 'placeholder' => '']) !!}
                ...
                {{--                    <div class="col-md-4">--}}
                {{--                        {!! Form::text('brand', $consumableItem->brand, ['class'=>'form-control']) !!}--}}
                {{--                        @error('brand')--}}
                {{--                        <strong>{{ $message }}</strong>--}}
                {{--                        @enderror--}}
                {{--                    </div>--}}
