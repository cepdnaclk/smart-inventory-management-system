    ...
    <div>
        <x-backend.card>
            ...
            <x-slot name="body">
                ...
                <a href="{{ route('admin.consumable.items.edit', $cm) }}" class="btn btn-info btn-xs"><i class="fa fa-pencil"
                        title="Edit"></i>
                </a>
                <a href="{{ route('admin.consumable.items.delete', $cm) }}" class="btn btn-danger btn-xs"><i
