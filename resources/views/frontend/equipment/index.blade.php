...
@section('content')
    <div class="container py-4">
        <div class="row">
            <div class="col">
                <h3 class="d-flex align-self-end">Browse Equipments by Category</h3>
            </div>
            <div class="col-sm-2 text-right">
                <a class="btn btn-primary" href="{{ route('frontend.equipment.index.all') }}">View All </a>
            </div>
        </div>
                            ...
                            <div class="col-6 col-sm-3 col-md-2 p-1 d-flex">
                                <div class="text-center card">
                                    <a class="text-decoration-none"
                                        href="{{ route('frontend.equipment.category', $type) }}">
