...
class StationsSeeder extends Seeder
{
    ...
    protected $data = [
        ...
        array('id' => '4', 'stationName' => 'Assembly Station A', 'description' => 'Students can use this table to keep the materials and do basic assembly works using light tools such as screwdrivers, paper cutters, etc… Those tools will be available as a moveable tools rack', 'thumb' => '1657540797.jpg', 'capacity' => '3', 'created_at' => '2021-08-04 15:23:56', 'updated_at' => '2022-07-07 18:26:23'),
        array('id' => '5', 'stationName' => 'Assembly Station B', 'description' => 'Students can use this table to keep the materials and do basic assembly works using light tools such as screwdrivers, paper cutters, etc… Those tools will be available as a moveable tools rack', 'thumb' => '1657540797.jpg', 'capacity' => '3', 'created_at' => '2022-07-07 18:26:43', 'updated_at' => '2022-07-07 18:26:43')
    ];
