...
class StationsSeeder extends Seeder
{
    ...
    protected $data = [
        ...
        array('id' => '5', 'stationName' => 'Assembly Station B', 'description' => 'Students can use this table to keep the materials and do basic assembly works using light tools such as screwdrivers, paper cutters, etc… Those tools will be available as a moveable tools rack', 'thumb' => '1657218403.jpg', 'capacity' => '3', 'created_at' => '2022-07-07 18:26:43', 'updated_at' => '2022-07-07 18:26:43')
    ];
